<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yemek_Tarifleri_Sitem2.AnaSayfa" %>
            ...
            <table class="auto-style4">
                <tr>
                    <td style="background-color: #FF9966">
                        ...
                        <asp:Label ID="Label3" runat="server" style="font-size: x-large; font-weight: 700" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                    </td>
                </tr>
                <tr>
